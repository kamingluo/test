    ...
    <div class="container">
     <div class="handle-box">
        ...
        >
          ...
          <el-option key="3" label="EW系统" value="EW系统"></el-option>
        </el-select>
       <!-- <el-input
          v-model="select_word"
          placeholder="筛选关键词"
      ...
      <div class="handle-box">
        ...
        >
         ...
         <!-- <el-button type="primary" class="handle-del mr10" @click="clicktest">测试按钮</el-button>-->
      ...
      >
        ...
        <el-table-column prop="request_url" label="请求接口" width="190">
        </el-table-column>
